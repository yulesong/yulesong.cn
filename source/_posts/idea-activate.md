...
修改host文件，获取注册码激活IDEA

<!-- more -->

## 修改host文件
打开路径C:\Windows\System32\drivers\etc，修改host文件，在末尾追加域名 0.0.0.0 account.jetbrains.com 及 0.0.0.0 www.jetbrains.com

## 输入激活码
访问lanyus地址：http://idea.lanyus.com/（这里可不用访问，直接复制下面一行注册码）点击获得注册码，
``` bash
...
```
## 具体步骤如下：
*   ![](/img/idea-activate1.png)

*   ![](/img/idea-activate2.png)

*   ![](/img/idea-activate3.png)
